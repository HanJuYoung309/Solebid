                ...
                <div className="flex items-center space-x-4">
                    ...
                    {isLoggedIn ? (
                        <div className="relative">
                            ...
                            >
                                <button onClick={() => navigate('/profile')} className="w-full text-left block px-4 py-2 text-gray-700 hover:bg-gray-50">
                                    <i className="fas fa-user mr-2"></i>마이페이지
                                </button>
                                <button onClick={() => navigate('/settings')} className="w-full text-left block px-4 py-2 text-gray-700 hover:bg-gray-50">
